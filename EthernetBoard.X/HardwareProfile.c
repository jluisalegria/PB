...
#pragma config WPEND = PAGE_WPFP// Write/Erase Protect Region Select bit (valid when WPDIS = 0) (Pages WPFP<6:0> through Configuration Words erase/write protected)
    ...
    #define MAX_SPI_CLK_FREQ_FOR_P2P             (100000)
...
void BoardInit(void)
{
        ...
        SCK2_TRIS = 0;
           ...
           //mPORTFSetPinsDigitalOut(PIC32MX_SPI1_SDO_SCK_MASK_VALUE);     <configurar pines SPI>
           //mPORTFSetPinsDigitalIn(PIC32MX_SPI1_SDI_MASK_VALUE);
        
           /* Set the INT1 port pin to input */
           //mPORTESetPinsDigitalIn(BIT_8 | BIT_9);  <configurar pines >
           
          // mPORTBSetPinsDigitalOut(BIT_2 | BIT_4); <configurar pines >
           //mPORTGSetPinsDigitalOut(BIT_2);         <configurar pines >
        ...
        // Make RB0 as Digital input
        //AD1PCFGbits.PCFG2 = 1;      <configurar pines >
               ...
               // {
                 ...
                 //   {
                  ...
                  //  }
                    ...
                    //Rs485Buff[Rs485BuffIndex++]= RCREG1;
                //}
           //}
