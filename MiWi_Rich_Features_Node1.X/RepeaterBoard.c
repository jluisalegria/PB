...
_U08 myNodeNumber = 140;                      // Como es un repetidor le ponemos un ID mayor que PCDevices
...
/*----------------------------------------------------------------------------*/
 ...
 {/*******************************************************************/
     ...
     if(SwTimer3 >= 100)           // if lost connection ...
     {
         Reset();
     }
 }
...
void main(void)
{
    ...
    PPSLock();
     ...
     TRISA&=0xDF;   //JL: Configuro el pin B4 como salida si modificar el estado de los demas pines
