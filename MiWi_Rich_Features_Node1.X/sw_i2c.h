...
#define  DATA_LOW   TRISBbits.TRISB7 = 0; // define macro for data pin output
#define  DATA_HI    TRISBbits.TRISB7 = 1; // define macro for data pin input
#define  DATA_LAT   LATBbits.LATB7        // define macro for data pin latch
#define  DATA_PIN   PORTBbits.RB7         // define macro for data pin
...
#define  DATA_LOW   TRISCbits.TRISB7 = 0; // define macro for data pin output
#define  DATA_HI    TRISCbits.TRISB7 = 1; // define macro for data pin input
#define  DATA_LAT   LATCbits.LATB7        // define macro for data pin latch
#define  DATA_PIN   PORTCbits.RB7         // define macro for data pin

#define  CLOCK_LOW  TRISCbits.TRISB6 = 0; // define macro for clock pin output
#define  CLOCK_HI   TRISCbits.TRISB6 = 1; // define macro for clock pin input
#define  SCLK_LAT   LATCbits.LATB6        // define macro for clock pin latch
#define  SCLK_PIN   PORTCbits.RB6         // define macro for clock pin
#endif
