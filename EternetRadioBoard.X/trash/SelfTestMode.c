...
void SelfTest(BYTE myChannel)
{
    ...
    ConsolePutROMString((ROM char *)"\r\nMiWi  Demo    Self Test Mode ");
    ConsolePutROMString((ROM char *)"\r\nSW1: Start Test SW2: Exit Test ");
            ...
            while(1)
            {
                ...
                switch(init_case)
                {
                    case 0: //Test  MAC EEPROM 
                            ...
                            if((EEPROM_Val[0] == 0x00) && (EEPROM_Val[1] == 0x1E) && (EEPROM_Val[2] == 0xC0))
                                init_case++;
                            else init_case = 255;
                            break;
