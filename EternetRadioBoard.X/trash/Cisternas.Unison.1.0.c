...
_U32 const HOP_1_MAC = 0x01020304;
_U32 const HOP_2_MAC = 0x01020304;
...
#if ADDITIONAL_NODE_ID_SIZE > 0
    BYTE AdditionalNodeID[ADDITIONAL_NODE_ID_SIZE] = {0x03};
#endif
 ...
 void TxWirelessTask(void)
 {
    if(((myNodeNumber == 0)&&(SwTimer0 >= (_U08)NUM_NODOS))||(SoftwareRequest==1))
    {
        if(SoftwareRequest==1)
        {
            ...
            MiApp_WriteData(NewRLYStats>>24);
            MiApp_WriteData(NewRLYStats)>>16;
            MiApp_WriteData(NewRLYStats>>8);
            MiApp_WriteData(NewRLYStats);
...
////////////////////////////////////////////////////////////////////////////////
 ...
 void GetNodeData(void)
 {
     ...
     if(SoftwareRequest==2)  //if waiting for response to ack the software...
     {
         ...
         if(Nodes_Ready  >= 256)     // si ha respondido nodo 5
         {
             SoftwareRequest =3;
         }
     }
...
////////////////////////////////////////////////////////////////////////////////
 void TXETHERNET(void)
 {
  ...
  if((SwTimer1 >= 5)||(SoftwareRequest == 3))
  {
   SwTimer1 = 0;
