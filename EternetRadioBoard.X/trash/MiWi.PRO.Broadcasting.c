...
/******************************************************************/
    ...
    BYTE AdditionalNodeID[ADDITIONAL_NODE_ID_SIZE] = {0x55AA};
#endif
...
{   
    ...
    while((Eeprom25xx_u8ReadStatus(EEPROM25XX_MEMORY0) & EEPROM25XX_BUSY) == 1);
    Eeprom25xx_Write(EEPROM25XX_MEMORY0,&EEBYTE, 0,64);
   ...
   while((Eeprom25xx_u8ReadStatus(EEPROM25XX_MEMORY0) & EEPROM25XX_BUSY) == 1);
   Eeprom25xx_Read(EEPROM25XX_MEMORY0, &EEBYTE,0,64);
...
*/
    ...
    // {
     // while((Eeprom25xx_u8ReadStatus(EEPROM25XX_MEMORY0) & EEPROM25XX_BUSY) == 1);
     // Eeprom25xx_Write(EEPROM25XX_MEMORY0,&EEBYTE, m,32);
     // m+=32;
      //LED_1 ^= 1;
    //}
        ...
        else
        {
            ...
            /*******************************************************************/
                ...
                //MiApp_StartConnection(START_CONN_DIRECT, 10, 0x02000000);
            #endif
        }
        ...
        //while((Eeprom25xx_u8ReadStatus(EEPROM25XX_MEMORY0) & EEPROM25XX_BUSY) == 1);
    //Eeprom25xx_Read(EEPROM25XX_MEMORY0, &EEBYTE,0,1024);
    }
    else
    {
