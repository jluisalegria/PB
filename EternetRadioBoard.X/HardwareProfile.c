...
//extern BYTE Rs485Buff[24];
//extern BYTE Rs485BuffIndex;

/* RADIO_BOARD */
/*esta definicion solo debe usarce en el caso del proyecto playa bonita*/
/*define un buffer y variables para la recepcion de comandos seriales desde la tarjeta Bridge Board con PIC32*/

#define RADIO_BOARD            
                              
#if defined (RADIO_BOARD)
extern BYTE UartBuff[32];
extern BYTE Uart2RXState;
...
// CONFIG1L
#pragma config WDTEN = ON      // Watchdog Timer (Disabled - Controlled by SWDTEN bit)
...
// CONFIG2H
#pragma config WDTPS = 16384    // Watchdog Postscaler (1:32768)
...
void BoardInit(void)
{
        ...
        //WDTCONbits.ADSHR = 1;        // configuracion de canales analogicos
        ...
        SCK2_TRIS = 0;
            ...
            SSP2STAT = 0x40;
            SSP2CON1 = 0x21;            //clock = FOSC/16 (Max SCk for Data is 1MHz)
            INTCON2bits.INTEDG3 = 1;
...
BYTE ButtonPressed(void)
{
    ...
    void UserInterruptHandler(void)
    {
        ...
        /* Esta funcion es utilizada con la tarjeta PANCOORDINATOR en el proyecto playa bonita  */
        /* Es recomendable comentarla totalmente en caso de compilarse para otro proyecto       */
        #if defined (RADIO_BOARD)
            if(PIR3bits.RC2IF)
               {
                 PIR3bits.RC2IF = 0;
                 if(RCSTA2bits.OERR)
                 {
                   ...
                   switch(Uart2RXState)
                   {
                       ...
                       case 3:
                       {
                           ...
                           //UartBuff[BuffIndex] = RCREG2;
                           UartBuff[BuffIndex] = data;
                           ++BuffIndex;
